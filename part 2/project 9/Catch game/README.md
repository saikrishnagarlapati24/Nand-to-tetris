Thsi project introduces the high-level programming language used on the computer, Jack, an oject-oriented language which has most of the basic functionality that Java has and is 
similar to it. 
